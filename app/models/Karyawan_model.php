...
class Karyawan_model
{
  ...
  public function tambahDataKaryawan($data)
  {
    $NoTelp = preg_replace('/\D/', '', $data['NoTelp']);
     ...
     $query = 'INSERT INTO users (NIK, Nama, NamaUser, Password, JenisKelamin, Alamat, NoTelp, Foto, RoleId, IsActive) VALUES (:NIK, :Nama, :NamaUser, :Password, :JenisKelamin, :Alamat, :NoTelp, :Foto, :RoleId, :IsActive)';
    $this->db->query($query);
