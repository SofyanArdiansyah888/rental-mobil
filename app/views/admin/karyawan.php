    ...
    <div class="col-md clear-fix">
      <?php if ($_SESSION['Login']['RoleId'] == 1) : ?>
        <button class="btn btn-primary mb-3 shadow-none float-right" type="button" data-toggle="modal" data-target="#inputUser">
          <i class="fa fa-plus fa-fw" aria-hidden="true"></i> Tambah Karyawan
        </button>
      <?php else : ?>
              ...
              <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body px-5 grey lighten-5">
                    ...
                    <form action="<?= BASEURL; ?>/Admin/editKaryawan/" method="post" role="form">
                      ...
                      <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="NamaUser" name="NamaUser" value="<?= $user['NamaUser'] ?>" readonly>
                      </div>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body px-5 grey lighten-5">
          ...
          <form action="<?= BASEURL; ?>/Admin/tambahKaryawan" method="post" role="form">
        ...
        <div class="modal-footer text-center justify-content-center">
          <button type="button" class="btn btn-outline-primary shadow-none" data-dismiss="modal">Keluar</button>
          <button type="submit" class="btn btn-primary shadow-none" id="submitsimpan">Simpan Data</button>
        </div>
        </form>
        <!-- AKHIR FORM -->
      </div>
