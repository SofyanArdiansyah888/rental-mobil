        ...
        <div class="col">
          ...
          <div class="form-group" id="hargaSewaRental">
            ...
            <div class="input-group">
              ...
              <input type="text" class="form-control" id="TarifMobilPerhari" value="<?= $data['mobilrental']['HargaSewa'] ?>" >
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div id="showSopir" class="d-none">
              <div class="form-group">
                <select class="browser-default custom-select select2" name="Sopir" id="Sopir">
              ...
              <div class="form-group" id="tarifSopir">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" id="TarifSopirPerhari" name="TarifSopirPerhari" value="0">
                </div>
              </div>
            </div>
          </div>
